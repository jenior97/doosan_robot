...
class a0912_plan(object):
    def __init__(self):
        super(a0912_plan, self).__init__()
        #rospy.init_node("baxter_plan", anonymous=False)

        self.robot = RobotCommander()
    def pose_plan_path(self, object_pose, object_orientation=(0, pi, 0), arm ="arm" ,approach_direction="vertical"):
    ...
    # )
        ...
        if approach_direction == "horizon":
            q = quaternion_from_euler(0, pi, -pi/2) # horizon direction approach
        elif approach_direction == "vertical":
            q = quaternion_from_euler(0, pi, -pi/2)  # vertical direction approach
        else:
    ...
    def position_plan_path(self, desired_position, object_orientation=(0, pi, 0), arm ="arm"):
    ...
    def plan_cartesian_path(self, wpose, scale=1, arm="arm"):
