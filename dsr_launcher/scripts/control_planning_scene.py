...
class control_planning_scene(object):
    ...
    def _get_planning_objects_name(self, get_ps_srv):
        get_req_ = GetPlanningSceneRequest()
        psc = PlanningSceneComponents()
        psc.components = PlanningSceneComponents.WORLD_OBJECT_NAMES
        get_req_.components = psc
    ...
    def attach_object(self, _object, grasping_group="robotiq_2f"):
    ...
    def detach_object(self, _object, grasping_group="robotiq_2f"):
    ...
    def remove_object(self, _object, grasping_group="hand"):
